    ...
    <div className="flex h-full">
      ...
      <div className="flex-1 p-[40px] overflow-y-auto">
        <div className="max-w-[600px]">
          <h2 className="text-[28px] mb-[8px] text-black">Shipping Address</h2>
          <p className="text-gray-500 mb-[32px]">Manage your shipping information</p>

          <form className="flex flex-col gap-[24px]">
            <div className="flex flex-col gap-[8px]">
              <label htmlFor="fullName" className="text-[14px] text-black">
                Full Name
              </label>
              <input
                id="fullName"
            ...
            <div className="flex flex-col gap-[8px]">
              <label htmlFor="shippingAddress" className="text-[14px] text-black">
                Street Address
              </label>
              <input
                id="shippingAddress"
            ...
            <div className="flex flex-col gap-[8px]">
              <label htmlFor="apartment" className="text-[14px] text-black">
            ...
            <div className="grid grid-cols-2 gap-[16px]">
              <div className="flex flex-col gap-[8px]">
                <label htmlFor="shippingCity" className="text-[14px] text-black">
                  City
                </label>
                <input
                  id="shippingCity"
              ...
              <div className="flex flex-col gap-[8px]">
                <label htmlFor="shippingState" className="text-[14px] text-black">
                  State
                </label>
                <input
                  id="shippingState"
            ...
            <div className="grid grid-cols-2 gap-[16px]">
              <div className="flex flex-col gap-[8px]">
                <label htmlFor="shippingZip" className="text-[14px] text-black">
                  ZIP Code
                </label>
                <input
                  id="shippingZip"
              ...
              <div className="flex flex-col gap-[8px]">
                <label htmlFor="shippingCountry" className="text-[14px] text-black">
                  Country
                </label>
                <input
                  id="shippingCountry"
