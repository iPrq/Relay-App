...
function Frame110() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[24px] h-[1024px] items-start left-[1078px] overflow-clip shadow-[1px_0px_0px_0px_rgba(0,0,0,0.08)] top-0 w-[362px]">
      <Frame43 />
      <Frame44 />
